...
sed -i '/uci commit system/i\uci set system.@system[0].hostname='Chen-R4A'' package/lean/default-settings/files/zzz-default-settings
...
sed -i 's/ssid=OpenWrt/ssid=Chen_home/g' package/kernel/mac80211/files/lib/wifi/mac80211.sh
